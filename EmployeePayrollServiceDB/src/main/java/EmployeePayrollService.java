...
public class EmployeePayrollService {
    ...
    /***
     * created readAverageSalaryByGender to read average salary by gender
     * @param ioService - passing service
     * @return
     */
    public Map<String, Double> readAverageSalaryByGender(IOService ioService) {
        if (ioService.equals(IOService.DB_IO)) {
            return payrollServiceDB.getAverageSalaryByGenderDB();
        }
        return null;
    }

    /***
     * created addNewEmployee method to add new employee
     * @param employeeName - passing employee name
     * @param gender - passing gender
     * @param salary - passing salary
     * @param startDate - passing start date
     */
    public void addNewEmployee(String employeeName, String gender, double salary, LocalDate startDate) {
        employeePayrollDataList.add(payrollServiceDB.addNewEmployeeToDB(employeeName, gender, salary, startDate));
    }
}
